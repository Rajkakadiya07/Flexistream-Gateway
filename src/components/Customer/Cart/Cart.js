                    ...
                    <div className="col-lg-5">
                      <div className="me-lg-5">
                        <div className="d-flex">
                          <img
                            src="https://i0.wp.com/www.choovio.com/wp-content/uploads/2023/11/ts301-min.jpg?resize=300%2C300&ssl=1"
                  ...
                  <div className="row gy-3 mb-4">
                    <div className="col-lg-5">
                      <div className="me-lg-5">
                        <div className="d-flex">
                          <img
                            src="https://d2g2p0i8cc2bmh.cloudfront.net/2022-12/LoRaWAN-IoT-Devices-Group.png"
                            className="border rounded me-3"
                            style={{ width: 96, height: 96 }}
                          />
                          <div className="">
                  ...
                  <div className="row gy-3">
                    <div className="col-lg-5">
                      <div className="me-lg-5">
                        <div className="d-flex">
                          <img
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMFKKmQpyB-Kdl7BUiGWgl4Z_zRsl1W4VnpQ&usqp=CAU"
                            className="border rounded me-3"
                            style={{ width: 96, height: 96 }}
                          />
                          <div className="">
